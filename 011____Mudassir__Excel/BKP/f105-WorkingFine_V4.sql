...
--   Date and Time:   09:52 Wednesday May 6, 2020
...
,p_last_upd_yyyymmddhh24miss=>'20200506095100'
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(28153502808320718)
,p_name=>'G_DEVICE_TYPE'
...
'',
'',
'.display_only.apex-item-display-only.P4_BALANCE{',
'    color: #111;',
'  display: inline-block;',
'  border-bottom: 2px solid #ce2721;',
'  font-size: 1.5rem;',
'  font-weight: 900;  ',
'  margin-top: 5px;',
'  margin-bottom: 15px;',
...
,p_plug_display_when_condition=>':P4_DATA_FOUND=''Y'' and :G_DEVICE_TYPE=''NOT-MOBILE'''
,p_attribute_01=>'N'
,p_attribute_06=>'Y'
,p_attribute_07=>'Y'
);
...
,p_query_order_by=>'bill_no,bill_date desc'
,p_include_rowid_column=>false
...
,p_colspan=>2
,p_grid_label_column_span=>0
,p_field_template=>wwv_flow_api.id(25853713369762737)
...
'where suppliers_id=:P4_SUPPLIERS',
'order by bill_no,bill_date desc ;',
...
'''',
' <tr>',
'    <td>''||to_char(i.bill_date,''DD-MON-YYYY'')||''</td>',
'    <td>''||i.PARTICULERS||''</td>',
'    <td>''||i.ITEM_SIZE||''</td>',
'    <td>''||i.QTY||''</td>',
'    <td>''||i.rate||''</td>',
...
,p_last_updated_by=>'ORCLAPEXUSER2'
,p_last_upd_yyyymmddhh24miss=>'20200506083128'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(27860687066401641)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'AfterLoginProcess'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'if device_categorizr.ismobile then',
':G_DEVICE_TYPE:=''MOBILE'';',
'else',
':G_DEVICE_TYPE:=''NOT-MOBILE'';',
'end if;',
'end ;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
